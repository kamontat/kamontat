    ...
    <SocialBar>
      {social.map((s) => {
        if (s.key.toLowerCase() === "facebook")
          return <Facebook key={s.key} name={s.name} url={s.url} title={s.username} />
        else if (s.key.toLowerCase() === "twitter")
          return <Twitter key={s.key} name={s.name} url={s.url} title={s.username} />
        else if (s.key.toLowerCase() === "youtube")
          return <Youtube key={s.key} name={s.name} url={s.url} title={s.username} />
        else if (s.key.toLowerCase() === "linkedin")
          return <Linkedin key={s.key} name={s.name} url={s.url} title={s.username} />
        else if (s.key.toLowerCase() === "instagram")
          return <Instagram key={s.key} name={s.name} url={s.url} title={s.username} />
        else if (s.key.toLowerCase() === "github")
          return <Github key={s.key} name={s.name} url={s.url} title={s.username} />
        else {
